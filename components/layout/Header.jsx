...
function Header(props) {
  ...
  return (
    <header className=" w-full h-[92px] md:h-[105px] fixed left-0 right-0 z-20 font-raleway">
        ...
        <div className="py-6 md:py-8 top-0">
          <div className="hidden lg:flex flex-row justify-between items-center">
            ...
            <div className="flex flex-row gap-20 justify-center items-center">
              <div>
                <ul className="flex flex-row text-base gap-12 font-normal text-black">
                  <Link
                    href="/about"
                    className={
                      props.about
                  ...
                  >
                    <li
                      className={props.about ? "text-black/70 " : "text-black"}
                    >
                      About Sixteen Sands
                    </li>
                  </Link>
                  ...
                  >
                    <li className={props.team ? "text-black/70" : "text-black"}>
                      Team
                    </li>
                  </Link>
                </ul>
          ...
          <div  className="flex items-center ">
            <div className={"" + (isOpen ? " block" : " hidden")}>
              <ul data-aos="fade-left" className="   z-10 bg-[#e0e5e1] absolute left-0 top-[90px] md:top-[105px] flex flex-col justify-center items-center  w-full mr-12 gap-8 py-8 text-scoolynblue text-base font-normal ">
                <li>
                  <Link
                    href="/about"
                    className={
